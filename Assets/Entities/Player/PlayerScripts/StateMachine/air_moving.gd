...
func update(delta:float) -> void:
	...
	body.velocity.x = move_toward(body.velocity.x, body.direction.x * body.walkSpeed, (body.h_accel / 1.3) * delta)
	body.velocity.z = move_toward(body.velocity.z, body.direction.z * body.walkSpeed, (body.h_accel / 1.3) * delta)
